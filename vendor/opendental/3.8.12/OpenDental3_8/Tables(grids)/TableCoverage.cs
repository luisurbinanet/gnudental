...
///<summary></summary>
	public class TableCoverage : OpenDental.ContrTable{
		...
		public void InstantClasses(){
			...
			LeftBorder[1,5]=Color.White;
			LeftBorder[2,5]=Color.Black;
			LeftBorder[3,5]=Color.White;
			...
			Cell[0,5]=Lan.g("TableCoverage","Primary Insurance Plan");
			Cell[2,5]=Lan.g("TableCoverage","Secondary Insurance Plan");
			FontBold[0,5]=true;
			FontBold[2,5]=true;
			...
			TopBorder[0,15]=Color.Black;
			TopBorder[2,15]=Color.Black;
			IsOverflow[1,19]=true;
			IsOverflow[3,19]=true;
			TopBorder[0,19]=Color.Black;
			TopBorder[1,19]=Color.Black;
			TopBorder[2,19]=Color.Black;
			TopBorder[3,19]=Color.Black;
			LeftBorder[1,19]=Color.White;
			LeftBorder[3,19]=Color.White;
			LeftBorder[2,20]=Color.Black;
			LayoutTables();
		}
