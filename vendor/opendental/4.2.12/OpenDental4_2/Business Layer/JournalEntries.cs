...
namespace OpenDental{
	...
	///<summary>Corresponds to the journalentry table in the database.  Used in accounting to represent a single credit or debit entry.  There will always be at least 2 journal enties attached to every transaction.  All transactions balance to 0.</summary>
	public class JournalEntry{
		...
		///<summary>fk to reconcile. 0 if not attached to a reconcile. Not allowed to alter amounts if attached.</summary>
