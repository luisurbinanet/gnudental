...
namespace OpenDental{
	...
	public class FormInsTemplates : System.Windows.Forms.Form{
		...
		private System.Windows.Forms.Button butEdit;// Required designer variable.
		...
		private void InitializeComponent(){
			...
			this.Table2.SelectionMode = SelectionMode.None;//OpenDental.SelectRowsMode.None;
			...
			this.butAdd.Size = new System.Drawing.Size(76, 28);
			...
			this.butDelete.Location = new System.Drawing.Point(358, 556);
			this.butDelete.Name = "butDelete";
			this.butDelete.Size = new System.Drawing.Size(76, 28);
			...
			this.butEdit.Location = new System.Drawing.Point(438, 556);
			this.butEdit.Name = "butEdit";
			this.butEdit.Size = new System.Drawing.Size(76, 28);
			...
			this.button4.Location = new System.Drawing.Point(768, 556);
			...
			this.butBlank.Size = new System.Drawing.Size(75, 28);
			...
			this.Text = Lan.g(this,"Insurance Templates");
		...
		private void FillTable(){	
			...
			Table2.Fields[6]=Lan.g(this,"Fmt");
			...
			for (int i=0;i<InsTemplates.List.Length;i++){
				...
				Table2.Cell[6,i]=Defs.GetName(DefCat.ClaimFormats,InsTemplates.List[i].ClaimFormat);
		...
		private void Table2_CellDoubleClicked(object sender, CellEventArgs e){
			...
			InsPlans.Cur.ClaimFormat=InsTemplates.List[e.Row].ClaimFormat;
		...
		private void butAdd_Click(object sender, System.EventArgs e) {
			FormInsTemplatesEdit FormInsTempEdit2=new FormInsTemplatesEdit();
			FormInsTempEdit2.IsNew=true;
			InsTemplates.Cur=new InsTemplate();
			FormInsTempEdit2.ShowDialog();
			FillTable();
		}
