...
namespace OpenDental{
	...
	public class FormDunningEdit : System.Windows.Forms.Form{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(FormDunningEdit));
		...
		private void FormDunningEdit_Load(object sender, System.EventArgs e) {
			...
			for(int i=0;i<Defs.Short[(int)DefCat.BillingTypes].Length;i++){
				...
				if(DunningCur.BillingType==Defs.Short[(int)DefCat.BillingTypes][i].DefNum){
		...
		private void butOK_Click(object sender, System.EventArgs e) {
			...
			if(listBillType.SelectedIndex==0){
				...
				DunningCur.BillingType=Defs.Short[(int)DefCat.BillingTypes][listBillType.SelectedIndex-1].DefNum;
			}
			if(radioAny.Checked){
