...
namespace OpenDental{
	...
	public class FormEmailMessageEdit : System.Windows.Forms.Form{
		...
		private void InitializeComponent()
		{
			...
			this.butDeleteTemplate.Image = ((System.Drawing.Image)(resources.GetObject("butDeleteTemplate.Image")));
		...
		private void butSend_Click(object sender, System.EventArgs e) {
			...
			try{
				...
				for(int i=0;i<MessageCur.Attachments.Count;i++){
					attach=new Attachment(PrefB.GetString("DocPath")+@"EmailAttachments\"+MessageCur.Attachments[i].ActualFileName);
