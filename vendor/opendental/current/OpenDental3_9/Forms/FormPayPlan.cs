...
namespace OpenDental{
	...
	public class FormPayPlan : System.Windows.Forms.Form{
		...
		private void InitializeComponent()
		{
			...
			// textStartBal
			// 
			this.textStartBal.AutoSize = false;
			...
			// textTotInt
			// 
			this.textTotInt.AutoSize = false;
