...
namespace OpenDental{
	...
	public class FormClearinghouses : System.Windows.Forms.Form{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(FormClearinghouses));
			...
			this.textBox1.Text = "Every e-claim will be sent to one of the following clearinghouses or carriers.  Y" +
				"ou can set a default clearinghouse where most of your e-claims should be sent.  " +
				"For the other clearinghouses, you must add any payor ID\'s that you want to go th" +
				"ere.";
			// 
			// butAdd
			// 
