...
namespace OpenDental{
	public class TableProg : OpenDental.ContrTable{
		...
		private void TableProg_Load(object sender, System.EventArgs e) {
			...
			Heading=Lan.g("tbProg","Progress Notes");
			Fields[0]=Lan.g("tbProg","Date");
			Fields[1]=Lan.g("tbProg","Th");
			Fields[2]=Lan.g("tbProg","Surf");
			Fields[3]=Lan.g("tbProg","Dx");
			Fields[4]=Lan.g("tbProg","Description");
			Fields[5]=Lan.g("tbProg","Stat");
			Fields[6]=Lan.g("tbProg","Prov");
			Fields[7]=Lan.g("tbProg","Amount");
