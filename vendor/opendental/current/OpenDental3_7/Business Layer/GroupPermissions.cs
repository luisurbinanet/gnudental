...
namespace OpenDental{
	...
	///<summary>Corresponds to the grouppermission table in database.</summary>
	public class GroupPermission{
		///<summary>Primary key.</summary>
		public int GroupPermNum;
		///<summary>Only granted permission if newer than this date.  Can be Min to always grant permission.</summary>
		...
		///<summary>Foreign key to usergroup.UserGroupNum.  The user group for which this permission is granted.  If not authorized, then this groupPermission will have been deleted.  If 0, then it is referring to permissions for multiuser mode.</summary>
		public int UserGroupNum;
		///<summary>See the Permission enumeration.</summary>
