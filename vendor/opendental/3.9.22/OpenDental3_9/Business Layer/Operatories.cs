...
namespace OpenDental{
	...
	///<summary>Corresponds to the operatory table in the database.</summary>
	public class Operatory{
		...
		///<summary>Foreign key to provider.ProvNum.  The dentist assigned to this op.  If more than one dentist might be assigned to an op, then create a second op and use one for each dentist. If 0, then no dentist is assigned.</summary>
		public int ProvDentist;
		///<summary>Foreign key to provider.ProvNum.  The hygienist assigned to this op.  If 0, then no hygienist is assigned.</summary>
