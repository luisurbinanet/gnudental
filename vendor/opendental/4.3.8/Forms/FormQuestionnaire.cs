...
namespace OpenDental{
	...
	public class FormQuestionnaire : System.Windows.Forms.Form{
		...
		///<summary></summary>
		public FormQuestionnaire(int patNum)
		{
			//
		...
		private void FillGrid(){
			...
			for(int i=0;i<QuestionList.Length;i++){
				...
				row.Cells.Add(QuestionList[i].Answer);
		...
		private void gridMain_CellDoubleClick(object sender,ODGridClickEventArgs e) {
			InputBox input=new InputBox(QuestionList[e.Row].Description);
			input.textResult.Text=QuestionList[e.Row].Answer;
			input.ShowDialog();
		...
		private void butDelete_Click(object sender,EventArgs e) {
			...
			if(!MsgBox.Show(this,true,"Are you sure you want to delete all questions and answers for this patient?")){
				return;
			}
			Questions.DeleteAllForPat(PatNum);
			FillGrid();
		}
