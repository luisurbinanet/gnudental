...
namespace OpenDental{
	...
	public class FormOpenDental : System.Windows.Forms.Form{
		...
		private MenuItem menuItemRemote2;
		...
		private void InitializeComponent(){
			...
			this.menuItemRemote2 = new System.Windows.Forms.MenuItem();
			...
			((System.ComponentModel.ISupportInitialize)(this.pictButtons)).BeginInit();
			this.SuspendLayout();
			// 
			// pictButtons
			// 
			...
			this.imageList2x6.Images.SetKeyName(0,"");
			// 
			// timerTimeIndic
			// 
			...
			// menuItemOperatories
			// 
			this.menuItemOperatories.Index = 12;
			...
			// menuItemPayPeriods
			// 
			this.menuItemPayPeriods.Index = 13;
			...
			// menuItemPractice
			// 
			this.menuItemPractice.Index = 14;
			...
			// 
			this.menuItemProcedureButtons.Index = 15;
			...
			// menuItemProvSched
			// 
			this.menuItemProvSched.Index = 24;
			...
			// 
			this.menuItemBlockoutDefault.Index = 25;
			...
			// menuItemRpProcNote
			// 
			this.menuItemRpProcNote.Index = 11;
			...
			// menuItemMonthly
			// 
			this.menuItemMonthly.Index = 13;
			this.menuItemMonthly.Text = "MONTHLY";
			// 
			// menuItemRpAging
			// 
			this.menuItemRpAging.Index = 14;
			...
			// 
			this.menuItemRpClaimsNotSent.Index = 15;
			...
			// 
			this.menuItemRpCapitation.Index = 16;
			...
			// 
			this.menuItemRpFinanceCharge.Index = 17;
			...
			// 
			this.menuItemRpOutInsClaims.Index = 18;
			...
			// 
			this.menuItemRpProcNoBilled.Index = 19;
			...
			// menuItemPHRawPop
			// 
			this.menuItemPHRawPop.Index = 32;
			...
			// menuItemPHScreen
			// 
			this.menuItemPHScreen.Index = 33;
			...
			// 
			this.menuItemCourseGrades.Index = 34;
			...
			// menuItemRemote2
			// 
			this.menuItemRemote2.Index = 4;
			this.menuItemRemote2.Text = "Remote Connection 2";
			this.menuItemRemote2.Click += new System.EventHandler(this.menuItemRemote2_Click);
			// 
			// menuItemUpdate
			// 
			...
			this.myOutlookBar.Size = new System.Drawing.Size(51,680);
			...
			this.ContrAppt2.Padding = new System.Windows.Forms.Padding(56,0,0,0);
			...
			((System.ComponentModel.ISupportInitialize)(this.pictButtons)).EndInit();
    ...
    private static extern int PlaySound(string name, IntPtr hmod, int flags);
      ...
      //BackupJobs.CheckForBackupJobs();      			
		...
		private void menuItemScanner_Click(object sender, System.EventArgs e) {
			...
			FormSS.ShowDialog();		
			SecurityLogs.MakeLogEntry(Permissions.Setup,0,"Scanner");
		}
