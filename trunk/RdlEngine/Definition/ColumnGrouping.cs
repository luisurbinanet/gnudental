...
namespace fyiReporting.RDL
{
	...
	internal class ColumnGrouping : ReportLink
	{
		...
		internal ColumnGrouping(Report r, ReportLink p, XmlNode xNode) : base(r, p)
		{
			_Height=null;
			...
			if (_Height == null)
				OwnerReport.rl.LogError(8, "ColumnGrouping requires either the Height element to be specified.");
